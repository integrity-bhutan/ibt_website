...
if ( ! function_exists('one_page_express_copyright')) {
    ...
    {
        $defaultText   = __('Contact us on Facebook', 'one-page-express');
        $copyrightText = apply_filters("one-page-express-copyright", $defaultText);

        return '' . wp_kses_post($copyrightText) . '<br/>&copy;&nbsp;' . "&nbsp;" . date_i18n(__('Y', 'one-page-express')) . '&nbsp;' . esc_html(get_bloginfo('name')) . '.&nbsp;';
    }
}
